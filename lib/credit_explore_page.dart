...
class _CreditExplorePageState extends State<CreditExplorePage> {
  ...
  final List<String> _faculties = ['情報科学部', '経済学部', '理学部', '文学部', '工学部', '総合科学部', '法学部'];
  final List<String> _categories = ['必修', '選択', 'その他'];
  final List<String> _daysOfWeek = ['月', '火', '水', '木', '金', '土', '日'];
  // ★タグ検索候補 (ダミー)
  final List<String> _tagSuggestions = ['楽単', 'テストなし', '出席ゆるい', 'レポートのみ', 'オンライン完結', 'グループワーク'];
  String? _selectedTag;
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              hint: Text('全ての$label', style: const TextStyle(color: Colors.grey)),
              onChanged: onChanged,
  ...
  Widget _buildRankingButton(BuildContext context, String label, String rankingType) {
    return Padding(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CreditResultPage(rankingType: rankingType, filterFaculty: rankingType == 'faculty_specific' ? _selectedFaculty : null),
            ),
          );
        },
        style: ElevatedButton.styleFrom(
